...
//		});
	...
	private void showTripInfo(int num) { // 버튼을 여기 ?
		try {
	...
	public void setMain() {
		...
		commerceBt = new JButton("주변 상권 정보");
		...
		//******************************************************************* 축제 정보 출력을 위한 버든
		leftBottom.add(festivalBt, "South");
		leftBottom.add(commerceBt, "South");
